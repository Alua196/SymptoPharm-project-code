...
const products = [
...

  {
    ...
    description:
      "AMOXSAN adalah obat antibiotik yang mengandung Amoxicillin 125 mg tiap 5 ml. Amoxicillin merupakan turunan Penisilin dengan aktifitas antibakteri spektrum luas. \r\nObat ini bersifat bakterisid yang efektif terhadap bakteri Gram negatif dan Gram positif seperti Staphylococci, Streptococci, Enterococci, S. pneumoniae, N. gonorrhoeae, H influenzas, E. coli, dan P. mirabiis. \r\nDalam penggunaan obat ini harus SESUAI DENGAN PETUNJUK DOKTER.",
    reviews: [
      {
        rating: 4.6,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
...

  {
    ...
    description:
      "IMBOOST FORCE EXTRA STRENGTH TABLET merupakan suplemen dengan kandungan Echinacea purpurea herb dry extract, Blackelderberry fruit dry extract, Zn Piccolinate dalam bentuk kaplet salut selaput. Suplemen ini digunakan untuk membantu meningkatkan serta memelihara daya tahan tubuh sehingga mencegah dari sakit dan mempercepat penyembuhan. \r\nImboost extra strength bekerja cepat mengaktifkan sistem daya tahan tubuh secara langsung di sistem pertahanan tubuh kita dengan memperbanyak antibodi sehingga daya tahan tubuh lebih kuat melawan serangan virus.",
    reviews: [
      {
        rating: 4.6,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
  ...
  },
  {
    ...
    description:
      "HOLISTICARE ESTER C TABLET merupakan suplemen yang mengandung Vitamin C dalam bentuk ester, sehingga lebih aman di lambung dan penyerapannya di dalam aliran darah menjadi lebih cepat, serta bertahan di dalam tubuh 2 kali lebih lama dibandingkan dengan vitamin C biasa (dalam bentuk Asam Askorbat). \r\nKandungan vitamin C pada suplemen ini memiliki peran sebagai antioksidan bagi tubuh. Selain itu, suplemen ini digunakan untuk memelihara daya tahan tubuh, dan mengatasi gejala kekurangan vitamin C.",
    reviews: [
      {
        rating: 4.6,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
...

  {
    ...
    description:
      "ENERVON C merupakan suplemen makanan dengan kandungan multivitamin seperti Vitamin C, Vitamin B1, Vitamin B2, Vitamin B6, Vitamin B12, Vitamin D, Niasinamide, Kalsium pantotenat dalam bentuk tablet salut. \r\nSuplemen vitamin ini berguna untuk membantu menjaga daya tahan tubuh. Kombinasi vitamin C dan B komplek yang diperlukan untuk tubuh yang kekurangan vitamin, supaya daya tahan tubuh tetap terjaga serta membantu memulihkan kondisi setelah sakit.",
    reviews: [
      {
        rating: 4.6,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
...

  {
    ...
    description:
      "POLYSILANE SIRUP merupakan obat maag dan anti kembung dengan kandungan Dimetilpolisiloksan, Aluminium hidroksida, dan Magnesium hidroksida dalam bentuk sirup. \r\nObat ini digunakan untuk mengurangi gejala yang berhubungan dengan kelebihan asam lambung, gastritis, tukak lambung, tukak usus 12 jari, dengan gejala-gejala seperti mual, nyeri lambung, nyeri ulu hati, kembung dan perasaan penuh pada lambung.",
    reviews: [
      {
        rating: 4.6,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
...

  {
    ...
    description:
      "BISOLVON EXTRA SIRUP mengandung Bromhexine HCl dan Guaifenesin. Obat ini digunakan untuk mengatasi batuk berdahak yang bekerja sebagai sekretolitik (mukolitik) dan ekspektoran untuk meredakan batuk berdahak dan mempermudah pengeluaran dahak pada saat batuk. \r\nObat ini akan membantu dengan 3 langkah kerja, yaitu: dengan Melepaskan, Mengencerkan, serta Mengeluarkan dahak, sehingga dahak dapat mudah dikeluarkan.",
    reviews: [
      {
        rating: 4.8,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
...

  {
    ...
    description:
      "PANADOL COLD & FLU merupakan obat dengan kandungan Paracetamol, Pseudoephedrine HCl, dan Dextromethorphan HBr. Obat ini dapat digunakan untuk meredakan gejala hidung tersumbat, batuk tidak berdahak, dan demam yang menyertai flu.",
    reviews: [
      {
        rating: 4.8,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
...

  {
    ...
    description:
      "PARACETAMOL TABLET merupakan obat yang dapat digunakan untuk meringankan rasa sakit pada sakit kepala, sakit gigi, dan menurunkan demam. Paracetamol sebagai analgetik, bekerja dengan meningkatkan ambang rasa sakit dan sebagai antipiretik yang diduga bekerja langsung pada pusat pengatur panas di hipotalamus.",
    reviews: [
      {
        rating: 4.8,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
...

  {
    ...
    description:
      "KOOLFEVER ADULT merupakan plester kompres penurun panas dan pereda nyeri, serta dapat memberikan efek dingin di saat cuaca panas pada orang dewasa. Plester ini dapat memberikan sensasi dingin hingga 8 jam.",
    reviews: [
      {
        rating: 4.8,
        text: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
